...
def get_struct_cell_abc(pri_struct):
    return pri_struct.lattice.a, pri_struct.lattice.b, pri_struct.lattice.c
...
if __name__ == '__main__':
    ...
    scaling_factor = 0.5                                          # The scale factor of the length of vector in VESTA file     
    ...
    pri_struct = write_vesta_file_from_poscar(cmd_vesta_path='D:\VESTA-win64\VESTA-win64\VESTA.exe', poscar_filename='POSCAR', dir_out_file=dir_out_file)
    lat_a, lat_b, lat_c = get_struct_cell_abc(pri_struct)
    ...
    write_Vesta_Mode(eigvecs, vesta_front, vesta_end, nat, scaling_factor, dir_out_file, lat_a, lat_b, lat_c)
