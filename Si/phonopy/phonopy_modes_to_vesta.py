...
def open_Vesta_file(dir_out_file, vesta_filename='primitive.vesta'):
    try:
        ...
        print("Cannot find Vesta in current directory")
        sys.exit(0)
    return vesta
...
if __name__ == '__main__':
    ...
    scaling_factor = 6                                          # The scale factor of the length of vector in VESTA file             
    ...
    write_Vesta_Mode(eigvecs_direct, vesta_front, vesta_end, nat, scaling_factor, dir_out_file)
